...
import type { GridMap, Rect, SpawnOptions, Vec2 } from "./types.js";
...
function tooClose(point: Vec2, points: Vec2[], minSep: number): boolean {
...
function findAnyOpenSpot(map: GridMap, solids: Rect[], bounds: Rect, tileSize: number): Vec2 | null {
