...
export function setFont(ctx: CanvasRenderingContext2D, size: number, bold?: boolean) {
    ctx.font = (bold ? "bold " : "") + size + "px 'Press Start 2P', monospace";
}

// Centers text if align is "center" (canvas default is left).
export function drawText(ctx: CanvasRenderingContext2D, text: string, x: number, y: number, size: number, color?: string, align?: CanvasTextAlign) {
...
export function wrapText(ctx: CanvasRenderingContext2D, text: string, size: number, maxWidth: number): string[] {
    setFont(ctx, size, false);
...
export function drawPanel(ctx: CanvasRenderingContext2D, x: number, y: number, w: number, h: number, fill?: string) {
...
export function drawGradientBar(ctx: CanvasRenderingContext2D, x: number, y: number, w: number, h: number, ratio: number, from: string, to: string, back?: string) {
...
export function drawIcon(ctx: CanvasRenderingContext2D, kind: string, x: number, y: number, size: number, color?: string) {
